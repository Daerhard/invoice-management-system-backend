...
(
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_purchase_invoice_item_invoice FOREIGN KEY (purchase_invoice_id) REFERENCES purchase_invoice (id)
);
...
ALTER TABLE purchase_invoice_document
    ...
    ADD CONSTRAINT fk_purchase_invoice_document_item FOREIGN KEY (purchase_invoice_item_id) REFERENCES purchase_invoice_item (id);
